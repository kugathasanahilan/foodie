...
<nav class="navbar navbar-expand-lg" style=" background-color: #2fd1d4;">
...
<body class="p-3 mb-2 text-dark" style="background-color: #2fd1d4;">
    <div class="container-fluid">
        <div class="row">
            <div class="col-9">
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <div class="card mt-4" style="height: 60rem;">
